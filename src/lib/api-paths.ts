...
export const paths = {
  ...
  rumMetrics: (orgId: string, minutes = 60) => `/api/v1/orgs/${orgId}/telemetry/rum?minutes=${minutes}`,
  rca: (orgId: string, service: string, minutes = 60) => `/api/v1/orgs/${orgId}/telemetry/rca?service=${encodeURIComponent(service)}&minutes=${minutes}`,
  correlation: (orgId: string, minutes = 60) => `/api/v1/orgs/${orgId}/correlation?minutes=${minutes}`,
  securityPosture: (orgId: string) => `/api/v1/orgs/${orgId}/security/posture`,
  channels: (orgId: string) => `/api/v1/orgs/${orgId}/channels`,
  channelTest: (orgId: string, id: string) => `/api/v1/orgs/${orgId}/channels/${id}/test`,
  channel: (orgId: string, id: string) => `/api/v1/orgs/${orgId}/channels/${id}`,
  statusComponents: (orgId: string) => `/api/v1/orgs/${orgId}/status-components`,
  statusComponent: (orgId: string, id: string) => `/api/v1/orgs/${orgId}/status-components/${id}`,
  profilingStatus: (orgId: string) => `/api/v1/orgs/${orgId}/profiling/status`,
  k8sStatus: (orgId: string) => `/api/v1/orgs/${orgId}/k8s/status`,
  k8sNodes: (orgId: string) => `/api/v1/orgs/${orgId}/k8s/nodes`,
  k8sNamespaces: (orgId: string) => `/api/v1/orgs/${orgId}/k8s/namespaces`,
  k8sPods: (orgId: string, ns: string) => `/api/v1/orgs/${orgId}/k8s/pods?ns=${ns}`,
  k8sDeployments: (orgId: string, ns: string) => `/api/v1/orgs/${orgId}/k8s/deployments?ns=${ns}`,
