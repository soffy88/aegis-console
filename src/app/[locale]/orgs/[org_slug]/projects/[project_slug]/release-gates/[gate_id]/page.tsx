...
export default function ReleaseGateDetailPage() {
  ...
  const t = useTranslations("releaseGates");
  ...
  if (queryError || !gate)
    return (
      <OErrorState
        error={queryError instanceof Error ? queryError.message : t("notFound")}
      />
    );
    ...
    <div className="space-y-6 max-w-4xl">
      ...
      {pendingDecision !== null && (
        <OConfirmDialog
          ...
          confirmLabel={pendingDecision === "approved" ? t("approve") : t("reject")}
