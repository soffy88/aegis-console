...
export default function AlertRuleDetailPage() {
  ...
  if (ruleLoading) return <OLoadingState message={t("loading")} />;
  if (ruleError || !rule)
    return (
      <OErrorState
        error={ruleError instanceof Error ? ruleError.message : t("notFound")}
      />
    );
        ...
        {canWrite && (
          <section className="space-y-3 rounded-lg border bg-card p-4">
            ...
            <div className="grid grid-cols-2 gap-2">
              <OFormField label={t("warnThreshold")}>
                <input
                  type="number"
              ...
              <OFormField label={t("critThreshold")}>
                <input
                  type="number"
