...
export default function InstallPage() {
  ...
  const mutation = useMutation({
    mutationFn: (payload: AppInstallPayload) =>
      aegisFetch<AppInstallResult>("/api/v1/apps/install", {
        method: "POST",
    ...
    <div className="max-w-lg space-y-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <OFormField
          ...
          htmlFor="install_dir"
          required
          error={errors.install_dir}
          help="Absolute path, no spaces"
        >
          <OTextInput
            id="install_dir"
            value={fields.install_dir}
            onChange={set("install_dir")}
        ...
        <OFormField label="Version" htmlFor="app_version" error={errors.app_version}>
          <OTextInput
            id="app_version"
            value={fields.app_version}
            onChange={set("app_version")}
            placeholder="1.0.0"
          />
        </OFormField>
